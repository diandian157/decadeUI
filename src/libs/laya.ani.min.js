  ...
  var BoneSlot = function () {
    ...
    _createClass(BoneSlot, [{
            ...
            if (graphics) {
              ...
              if (this._parentMatrix) {
                ...
                if (tCurrentMatrix) {
                  ...
                  if (tRotateKey) {
                    graphics.drawTexture(tTexture, -this.currDisplayData.height / 2, -this.currDisplayData.width / 2, this.currDisplayData.height, this.currDisplayData.width, tResultMatrix, alpha, null, this.blendType);
                  } else {
                    graphics.drawTexture(tTexture, -this.currDisplayData.width / 2, -this.currDisplayData.height / 2, this.currDisplayData.width, this.currDisplayData.height, tResultMatrix, alpha, null, this.blendType);
                  }
                }
              }
            }
      ...
      value: function copy() {
        ...
        tBoneSlot.blendType = this.blendType;
        return tBoneSlot;
      }
    }], [{
      key: "createSkinMesh",
    ...
    _createClass(Skeleton, [{
      ...
      value: function _createGraphics() {
        ...
        try {
          ...
          Laya.Browser.window["lastAniRes"] = this.effectUrl;
          ...
          var info = "错误信息:骨骼动画出错文件:" + this._templet.name + "错误描述:" + error;
    ...
    _createClass(Templet, [{
      ...
      value: function _parsePublicExtData() {
        ...
        for (i = 0; i < tTextureLen; i++) {
          ...
          if (!tTexture || !tTexture.bitmap) {
            var info = "错误信息:骨骼动画资源出错---文件:" + this._skBufferUrl;
        ...
        for (i = 0; i < tBoneSlotLen; i++) {
          ...
          var parent = tByte.readUTFString();

          if (parent.indexOf("_bl_add") > -1) {
              tDBBoneSlot.blendType = 1;
            } else if (tDBBoneSlot.name) {
            if (tDBBoneSlot.name.indexOf("_bl_add") > -1) {
                tDBBoneSlot.blendType = 1;
              } else {
              blendFlagIndex = tDBBoneSlot.name.indexOf("_blend_");

              if (blendFlagIndex > -1) {
                  tDBBoneSlot.blendType = Number(tDBBoneSlot.name.substring(blendFlagIndex + 7));
                }
            }
          }

          tDBBoneSlot.parent = parent;
      ...
      value: function destroy() {
        ...
        for (tTexture in this.subTextureDic) {
          if (tTexture && this.subTextureDic[tTexture]) {
            this.subTextureDic[tTexture].destroy();
          }
        }

        for (tTexture in this._textureDic) {
          if (tTexture && this._textureDic[tTexture]) {
