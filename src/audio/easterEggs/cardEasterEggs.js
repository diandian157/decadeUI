...
export const cardEasterEggs = [
	...
	{ cards: ["tao"], player: "guojia", targetHas: "caocao", text: "嘉，感丞相大恩，虽死不能报万一。", audio: "guojia1.mp3" },
	{
		...
		player: "guotu",
		targetHas: "yuanshao",
		text: "以明公之神武，引河朔之强众，以伐曹操，易如覆手，何必乃尔！",
		audio: "guotu1.mp3",
	},
	...
	{ cards: ["tao"], player: "simashi", targetHas: "xunyu", text: "贤才未有及荀令君者也。", audio: "simayi4.mp3" },
	{
		...
		player: "simazhao",
		targetHas: "zhonghui",
		text: "今四海安定，将勇兵精，可乘势取蜀，再顺流而下，水陆并进，平吴亦不在话下。",
		audio: "simazhao1.mp3",
	},
	{ cards: ["tao"], player: "caocao", targetHas: "liubei", text: "天下英雄，唯操与使君尔！", audio: "caocao22.mp3" },
	{ cards: ["tao"], player: "caocao", targetHas: "zhangxiu", text: "以德报怨，士者不以己悲。", audio: "caocao24.mp3" },
	{ cards: ["tao"], player: "liubei", targetHas: "caocao", text: "曹操若死，不知又有几人称王。", audio: "liubei10.mp3" },
	{ cards: ["tao"], player: "sunce", targetHas: "sunquan", text: "举贤任能，各尽其心以保江东，我不如卿。", audio: "sunce2.mp3" },
	{ cards: ["tao"], player: "sunce", targetHas: "taishici", text: "我知子义真丈夫也！", audio: "sunce4.mp3" },
	{ cards: ["tao"], player: "sunce", targetHas: "zhouyu", text: "周公瑾与孤，有总角之好、骨肉之分。", audio: "sunce5.mp3" },
	{ cards: ["tao"], player: "sunquan", targetHas: "ganning", text: "孟德有张辽，孤有兴霸，足以相敌也！", audio: "sunquan5.mp3" },
	...
	{ cards: ["sha"], player: "caocao", targetHas: "liubei", text: "玄德在家做的好大事！", audio: "caocao23.mp3" },
	{ cards: ["sha"], player: "liubei", targetHas: "caocao", text: "曹公可知谁为英雄？", audio: "liubei9.mp3" },
	{ cards: ["sha"], player: "sunce", targetHas: "guojia", text: "匹夫安敢料吾，吾誓取许昌！", audio: "sunce3.mp3" },
	{ cards: ["sha", "juedou"], player: "sunquan", targetHas: "zhangzhang", text: "当年如从张公之计，今日恐已乞食。", audio: "sunquan4.mp3" },
	...
	{ cards: ["juedou"], player: "guanyu", targetHas: "huangzhong", text: "不用拖刀计，实难取胜。", audio: "guanyu5.mp3" },
	{
		cards: ["juedou"],
		player: "huangzhong",
		targetHas: "xiahouyuan",
		text: "昔廉颇年八十，尚食斗米、肉十斤，何况黄忠未及七十乎？",
		audio: "huangzhong1.mp3",
	},
