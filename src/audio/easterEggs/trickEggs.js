...
export const trickEasterEggs = [
	...
	{ cards: ["juedou"], player: "lusu", condition: ctx => ctx.targets?.some(t => ctx.hasName(t, "guanyu")), text: "今屯兵于陆口，请关云长赴会！", audio: "lusu1.mp3" },
	{ cards: ["guohe"], player: "lvmeng", condition: ctx => ctx.targets?.some(t => ctx.hasName(t, "ganning")), text: "天下未定，斗将如甘宁难得，宜容忍之。", audio: "lvmeng1.mp3" },
	{ cards: ["juedou"], player: "machao", condition: ctx => ctx.targets?.some(t => ctx.hasName(t, "zhangfei")), text: "张翼德，汝的头在此，敢来取否？", audio: "machao4.mp3" },
	{ cards: ["bingliang"], player: "menghuo", condition: ctx => ctx.targets?.some(t => ctx.hasName(t, "zhugeliang")), text: "公，天威也，南人不复反矣。", audio: "menghuo1.mp3" },
	{ cards: ["nanman"], player: "menghuo", condition: ctx => ctx.targets?.some(t => ctx.hasName(t, "zhugeliang")), text: "你今第七次擒我，休来使诈！", audio: "menghuo2.mp3" },
	{ cards: ["guohe"], player: "miheng", condition: ctx => ctx.targets?.some(t => ctx.hasName(t, "caocao")), text: "宦官之后，除了挟天子以令诸侯，还懂什么治国安民！", audio: "miheng2.mp3" },
	{ cards: ["guohe"], player: "miheng", condition: ctx => ctx.targets?.some(t => ctx.hasName(t, "simayi")), text: "你这州牧，莫不是靠逢迎袁绍得来的？", audio: "miheng3.mp3" },
	{ cards: ["guohe"], player: "miheng", condition: ctx => ctx.targets?.some(t => ctx.hasName(t, "huangzu")), text: "竖子！我到阴间也要骂你不停！", audio: "miheng4.mp3" },
	{ cards: ["taoyuan"], player: "caocao", text: "前有梅林，甘酸足以止渴！", audio: "caocao20.mp3" },
	{ cards: ["shunshou"], player: "simayi", condition: ctx => ctx.targets?.some(t => ctx.hasName(t, "caocao")), text: "孟德公的大好江山，老夫替你好好治理把！", audio: "simayi2.mp3" },
	{ cards: ["wugu"], player: "jushou", condition: ctx => ctx.targets?.some(t => ctx.hasName(t, "yuanshao")), text: "挟天子以令诸侯，蓄士马以讨不庭，谁可御之？", audio: "jushou1.mp3" },
];
