...
export const gameStartDialogues = [
	...
	{
		players: ["zhugeliang", "luji"],
		dialogues: [{ player: "zhugeliang", text: "此真，旧病复发也。哈哈哈哈", audio: "zhugeliang4.mp3", delay: 500 }],
	},
	{
		players: ["zhugeliang", "simayi"],
		dialogues: [{ player: "zhugeliang", text: "仲达，想要我的四轮车吗？", audio: "zhugeliang3.mp3", delay: 500 }],
	},
	{ players: ["simahui", "zhugeliang"], dialogues: [{ player: "simahui", text: "孔明虽得其主，不得其时。", audio: "simahui1.mp3", delay: 500 }] },
	{
		players: ["zhangfei", "zhugeliang"],
		dialogues: [{ player: "zhangfei", text: "诸葛亮！俺今天就算绑，也要把你绑回去！", audio: "zhangfei2.mp3", delay: 500 }],
	},
	...
	{
		players: ["zhugeliang", "jiangwei"],
		dialogues: [{ player: "zhugeliang", text: "吾得伯约，如得一凤凰尔", audio: "zhugeliang5.mp3", delay: 500 }],
	},
	{
		players: ["zhugeliang", "pangtong"],
		dialogues: [{ player: "zhugeliang", text: "士元兄，倘若不如意，一定要来荆州啊", audio: "zhugeliang6.mp3", delay: 500 }],
	},
	...
	{
		players: ["zhangjiao", "liuhong"],
		dialogues: [{ player: "zhangjiao", text: "这覆舟的水，都是百姓的泪！", audio: "zhangjiao1.mp3", delay: 500 }],
	},
	...
	{
		players: ["jiangwei", "liubei"],
		dialogues: [{ player: "jiangwei", text: "往昔未见先主，今日始见龙颜！", audio: "jiangwei3.mp3", delay: 500 }],
	},
	{
		players: ["jiangwei", "liushan"],
		dialogues: [{ player: "jiangwei", text: "愿陛下忍数日之辱，臣必使社稷危而复安!", audio: "jiangwei4.mp3", delay: 500 }],
	},
	...
	{
		players: ["liubei", "zhugeliang"],
		dialogues: [{ player: "liubei", text: "备三顾先生茅庐，今日始见庐山。", audio: "liubei3.mp3", delay: 500 }],
	},
	{ players: ["liubei", "liubiao"], dialogues: [{ player: "liubei", text: "日月蹉跎人亦将老，而弟功业未建。", audio: "liubei4.mp3", delay: 500 }] },
	{
		players: ["liubei", "guanyu", "zhangfei"],
		dialogues: [{ player: "liubei", text: "昔年桃园一拜，今日沙场再会，誓同生死！", audio: "liubei5.mp3", delay: 500 }],
	},
	...
	{
		players: ["zhoushan", "zhangfei"],
		dialogues: [{ player: "zhoushan", text: "有话好好说，哪有见面就动手的？", audio: "zhoushan1.mp3", delay: 500 }],
	},
